...
<div class="row">
    <div class="col-12">
        ...
        <x-forms.input name="satuan" id="satuan" :label="__('field.satuan')" :isRequired="true" value="{{ $data['product']->satuan }}" />

        <x-forms.input type="number" name="stok" id="stok" :label="__('field.stok')" :isRequired="true" value="{{ $data['product']->stok }}" />
        ...
        <div class="text-right">
            <a href="{{ Route('master.product.index') }}" class="btn btn-secondary ">{{ __('button.cancel') }}</a>
