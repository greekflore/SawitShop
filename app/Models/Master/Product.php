...
class Product extends Model
{
    ...
    {
        // Mengambil ulasan melalui relasi orderDetails
        return $this->hasManyThrough(\App\Models\Review::class, \App\Models\Feature\OrderDetail::class, 'product_id', 'order_detail_id');
    }
